        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-14">
          ...
          {featured && (
            <Link
              ...
              className="group grid grid-cols-1 md:grid-cols-2 gap-0 rounded-2xl bg-white dark:bg-navy-900 border border-brand-500/10 shadow-xl overflow-hidden"
            >
              ...
              <div className="p-8 sm:p-10 flex flex-col justify-center">
                ...
                <h2 className="mt-2 text-2xl sm:text-3xl font-bold text-navy-950 dark:text-white">
                  {featured.title}
                </h2>
                <p className="mt-3 text-sm sm:text-base text-navy-600 dark:text-brand-200/80 leading-relaxed">
                  {featured.excerpt}
                </p>
