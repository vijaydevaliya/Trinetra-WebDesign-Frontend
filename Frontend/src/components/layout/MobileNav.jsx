          ...
          <div className="my-auto py-8 space-y-6">
            ...
            <motion.div variants={itemVariants}>
              <Link
                ...
                onClick={onClose}
                className={`text-2xl font-bold transition-colors ${
                  location.pathname === '/products' ? 'text-brand-400' : 'text-white hover:text-brand-300'
                }`}
              >
                Products
              </Link>
            ...
            <motion.div variants={itemVariants}>
              <Link
                ...
                onClick={onClose}
                className={`text-2xl font-bold transition-colors ${
                  location.pathname === '/projects' ? 'text-brand-400' : 'text-white hover:text-brand-300'
                }`}
              >
                Projects
              </Link>
            ...
            <motion.div variants={itemVariants}>
              <Link
                ...
                onClick={onClose}
                className={`text-2xl font-bold transition-colors ${
                  location.pathname.startsWith('/blogs') ? 'text-brand-400' : 'text-white hover:text-brand-300'
                }`}
              >
                Blogs
              </Link>
